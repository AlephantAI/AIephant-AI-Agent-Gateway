#!/usr/bin/env python3
"""OpenAI Agents-compatible example for Alephant MCP SSE tools."""
...
STEP_ID = os.getenv("STEP_ID", "step_mcp_sse_openai_agents")
...
def main() -> None:
    ...
    call = request_json(
        "/v1/agent/tools/call",
        {
            ...
            "run_id": RUN_ID,
            "step_id": STEP_ID,
            "tool_call_id": "call_mcp_sse_openai_agents",
