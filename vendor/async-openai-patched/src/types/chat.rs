...
pub struct ChatCompletionResponseMessage {
    ...
    /// Reasoning/thinking content generated by reasoning models.
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub enum ReasoningEffort {
    /// No extended reasoning (OpenAI Responses API default for many models).
    None,
    Low,
    Medium,
    High,
    /// Extra reasoning budget beyond `high`.
    XHigh,
}
...
pub struct CreateChatCompletionRequest {
    ...
    /// that custom or vendor-specific fields (e.g. from Cursor) survive
    /// deserialization → re-serialization round-trips.
    #[serde(flatten)]
    #[builder(default)]
    pub extra: std::collections::HashMap<String, serde_json::Value>,
}
...
pub struct ChatCompletionStreamResponseDelta {
    ...
    /// The refusal message generated by the model.
    pub refusal: Option<String>,
    /// Reasoning/thinking content generated by reasoning models (o1, o3, Claude thinking, etc.).
    #[serde(skip_serializing_if = "Option::is_none")]
    pub reasoning_content: Option<String>,
}
